        ...
        <div className="tickerParent">
          <div id="ticker" className="row">
            <div className="container">
              ...
              <div id="second">
                <ul>
                  <li><h1 className="lightergray">New Zealand</h1></li>
                  <li><h1 className="lightergray">buildings</h1></li>
                  <li><h1 className="lightergray">Education</h1></li>
                  <li><h1 className="lightergray">discussions</h1></li>
                  <li><h1 className="lightergray">environment</h1></li>
                  <li><h1 className="lightergray">contributing</h1></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            ...
            <footer>
              <div className="row">
                <div className="col-lg-12">
                  <p>
                    <a href="https://github.com/careabout/careabout" rel="nofollow">
                      View the repo
                    </a> on GitHub
                  </p>
                  <p>
                    <a href="http://getbootstrap.com/" rel="nofollow">Bootstrap</a> Theme by
                    <a href="http://thomaspark.co/" rel="nofollow"> Thomas Park</a>
                  </p>
                  <p>Icons from
                    <a href="http://fortawesome.github.io/Font-Awesome/" rel="nofollow"> Font Awesome</a>. Web fonts from <a href="http://www.google.com/webfonts" rel="nofollow">Google</a>.
                  </p>
                </div>
              </div>
            </footer>
